                                    ...
                                    <div class="col-xs-12">
                                        <div class="container">
                                            <div class="card card-container">
                                                ...
                                                <div id="div_professores">
                                                    <button class="btn btn-lg btn-primary btn-block btn-signin" data-toggle="collapse" data-target="#professores">PROFESSORES</button>
                                                    <div id="professores" class="collapse">
                                                        <ul>
                                                            <?php
                                                            $sql = $mysqli->query("SELECT id,nomeProfessor FROM professor");
                                                            while ($row = $sql->fetch_array()) {
                                                                if ($row['id'] != 100) {
                                                                    echo '<li><a href="http://kraft.ads.cnecsan.edu.br/?id=' . $row['id'] . '" target="_blank">' . $row['nomeProfessor'] . '</a></li>';
                                                                }
                                                            }
                                                            ?>
                                                        </ul>
